...
@app.route("/post-june-report", methods=["GET"])
def post_june_report():
    """ОДНОРАЗОВИЙ: публікує червневий звіт по рекламі у CCO+board. Прибрати після."""
    thread = request.args.get("thread", "")
    report = (
        "📊 <b>Реклама — ЧЕРВЕНЬ 2026 (буд vs вих)</b>\n"
        "<i>вартість ліда 120 грн; «виручка» = маржа (бюджет у CRM)</i>\n\n"
        "<pre>"
        "               Ліди  Авто  Конв   Маржа     Витрати  Чистими    ROMI\n"
        "Будні(Пн-Пт)    918   138  15.0%  323 298  110 160  +213 138  2.93x\n"
        "Вихідні(Сб-Нд)  268     8   3.0%   12 500   32 160   -19 660  0.39x\n"
        "Разом          1186   146  12.3%  335 798  142 320  +193 478  2.36x"
        "</pre>\n\n"
        "<b>Головне за червень:</b>\n"
        "• 🔴 Вихідні — <b>В МІНУС</b>: маржа 12 500 vs витрати 32 160 → <b>−19 660 грн збитку</b> (ROMI 0.39×).\n"
        "• Конверсія вихідних лише <b>3.0%</b> (8 авто з 268) проти <b>15.0%</b> у будні.\n"
        "• Будні: <b>+213 тис чистими</b>, кожна гривня ×2.93.\n"
        "• Весь плюс дали будні; вихідні з'їли частину прибутку.\n"
        "• <b>Рекомендація:</b> у червні вихідну рекламу варто було вимкнути."
    )
