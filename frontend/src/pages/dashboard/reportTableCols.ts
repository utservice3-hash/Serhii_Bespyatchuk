...
export const REPORT_COLS: ColDef[] = [
  ...
  { key: "srcLeadgen", title: "зі створених: лідоген", core: false, val: (m) => m.srcLeadgen, foot: "add",
    help: "Скільки зі СТВОРЕНИХ угод періоду прийшли від лідогенератора (deals.lead_channel='leadgen'). Джерело: metrics.createdSplitByManager. Частина ПАРТИЦІЇ джерела: Σ чотирьох == «Створено». ⚠️ Не плутати з «Прийнято лідоген» — то ОКРЕМА метрика (KPI-факт)." },
