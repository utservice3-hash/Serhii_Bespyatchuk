...
export const REPORT_COLS: ColDef[] = [
  ...
  // те, що з числами дозволено робити, — тому інваріант стереже гейт `#164`, а не
  // домовленість.
  //
