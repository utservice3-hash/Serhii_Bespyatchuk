...
const CLS: { k: LeadgenDealClass; tab: string; color: string; hint: string }[] = [
  ...
  { k: "work", tab: "В роботі", color: MUTED,
    hint: "Угода менеджера не закрита грошима й не програна: у Кваліфікації (зокрема «Кваліфіковано / заявку на прорахунок отримано») або в повному циклі поза зоною «Очікуємо» — до «Контроль перед завантаженням». Більшість тут — «Відкладений запит»; бюджет здебільшого ще не проставлений" },
