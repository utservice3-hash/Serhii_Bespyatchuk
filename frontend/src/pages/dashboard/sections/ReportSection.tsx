...
export function ReportSection({
  ...
  const kpis = s
    ? [
        ...
        { label: "⏳ Очікувані оплати", value: formatAmount(s.expected), sub: "виставлені рахунки", color: "#b45309", hint: "Гроші на етапі «Виставлено рахунок» (знімок поточного стану) — виставлені рахунки, що очікують оплати. Ще НЕ в «Отриманих коштах»." },
        { label: "Середній чек", value: formatAmountFull(s.avgCheck), sub: "", hint: "(Успішно + оплата отримана + очікувані оплати) ÷ поставлені машини — єдиний стандарт (див. METRICS_GLOSSARY)." },
        ...
        { label: "Поставлені машини", value: s.dispatched.toLocaleString("uk-UA"), sub: formatAmount(s.dispatchedSum), hint: "Угоди повного циклу, створені в періоді, що ЗАРАЗ на «Виставлено рахунок»/«Оплата»/стадіях АВТО (снапшот-проксі — як у Звіті КВП і Статистиках)." },
