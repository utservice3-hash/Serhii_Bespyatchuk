      ...
      {open && (
        <>
          <p style={{ fontSize: 12, color: "var(--text-muted)", margin: "10px 0" }}>
            Від створення ліда в «Кваліфікації» до <b>першого реального контакту</b> менеджера з ним
            (перший дзвінок/повідомлення/нотатка людини, без Salesbot). Лід може стояти в етапі, а робота
            вже ведеться — рахуємо саме контакт, а не зміну етапу. <b>Вхідний дзвінок ≈ 0 хв.</b>
            Ліди без жодного контакту (ще не опрацьовані) не рахуються. Розбито за часом надходження (київський час).
          </p>
