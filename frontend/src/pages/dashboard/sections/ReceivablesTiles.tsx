    ...
    <div className="kpi-grid recv-kpis" style={{ marginBottom: 16 }}>
      ...
      {totals && (
        <div className="kpi-card">
          ...
          {/* 💡 ЗВІДКИ ЧИСЛО — ПЕРШИМ РЕЧЕННЯМ, ЗНАМЕННИК ДРУГИМ (14.09.2026).
              Привід: власниця помилилась у розрахунку, прочитавши «Заробили» як
              величину, ПОРАХОВАНУ з суми рахунків. Насправді це готове поле CRM
              («Бюджет» угоди), яке в цьому продукті вже є маржею; з повної суми
              рахунків рахується лише ВІДСОТОК поруч.
              🔴 ЧОГО ТУТ СВІДОМО НЕ НАПИСАНО: «оплата ще не надійшла». Формулювання
              просили, але воно недоведене — `deals.price` не каже про рух грошей
