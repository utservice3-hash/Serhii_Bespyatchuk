...
function HandoffMoneyCol({ m }: { m: LeadgenHandoffMoney | undefined }) {
  const hint = "Передача — угода, яку лідген кваліфікував у Продзвоні. З неї Kommo створює угоду менеджеру (той самий клієнт, до 2 хв). "
    ...
    + "Стан угоди — ЗАРАЗ: успішна (142), оплата отримана, у зоні «Очікуємо» Звіту (від виставлення рахунку до очікуємо оплату), ще в роботі (відкрита, поза зоною «Очікуємо»), програна. "
