...
/**
 * #361…#362b — ЛІДОГЕНЕРАЦІЯ: сім показників із подій CRM.
 *
...
test("#361 КОНВЕРСІЯ: нульовий знаменник дає null, а не 0 %", () => {
...
test("#361b 🪞 ДЗЕРКАЛО: стадії — ті самі id, що заміряні на проді", async () => {
...
test("#362 ЯДРО ЛІДОГЕНУ НЕ РАХУЄ ПО funnel_stage — там ОПР і прорахунки склеєні", () => {
...
test("#362b 🪞 ДЗЕРКАЛО: «успішний дзвінок» тримається на ОБОХ умовах — напрямок і поріг", () => {
