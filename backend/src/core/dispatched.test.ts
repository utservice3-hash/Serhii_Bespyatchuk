 ...
 *
 * 🪤 МЕЖА ДОКАЗУ, НАЗВАНА ТУТ, ЩОБ ЇЇ НЕ ВІДКРИВАЛИ ЩОРАЗУ НАНОВО. Половини ② і ③
 * стверджують про СТАН У БАЗІ, а не про текст коду. Отже саботаж джерела їх не
 * зачіпає: прибери засів нулів у стенді — рядки, вже записані джобою, не зміняться,
 * і гейт лишиться зеленим. Це НЕ означає, що він беззубий; це означає, що саботаж
 * пішов не в те місце. Пробити їх можна лише записом у прод, а цього ми не робимо.
 *
 * 📐 ЧИМ ВОНИ ДОВЕДЕНІ НАСПРАВДІ — трьома переходами стану на ЖИВИХ даних 02.09.2026,
 * і це сильніший доказ за синтетичний саботаж:
 *   ③ ЧЕРВОНА до викату лікування — у вересні 5 лідів із 6 (пара, що випала, застигла);
 *   ② ЧЕРВОНА на СПРАВЖНЬОМУ протіканні — `date_trunc('week','2026-07-01')` дав
 *     понеділок 29.06, і тижневий бакет із червневою датою отримав нуль. Цього не
 *     знайшли ні крок 0, ні приймання попереднього викату, ні пʼять саботажів — усі
 *     вони дивились на КОД, а гейт подивився на НАСЛІДОК У ДАНИХ;
 *   обидві ЗЕЛЕНІ після правки межі + відновлення дванадцяти рядків зі знімка.
 * Половина ① — про константу, і вона саботажем перевіряється звичайно (S8).
 */
