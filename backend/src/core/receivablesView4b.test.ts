...
/**
 * 💰 #401 — ПЛИТКА «ЗАРОБИЛИ» НАЗИВАЄ ПОЛЕ CRM, А НЕ ВДАЄ РОЗРАХУНОК.
 *
 ...
 */
test("#401 плитка «Заробили» називає ПОЛЕ CRM, з якого взято число", () => {
  const tiles = readFileSync(FE("pages/dashboard/sections/ReceivablesTiles.tsx"), "utf8");
...
/**
 * 🪞 #401b — І НЕ СТВЕРДЖУЄ ПРО ГРОШІ ТОГО, ЧОГО НЕ ЗНАЄ.
 *
 ...
 */
test("#401b 🪞 плитка називає скоуп боргом і НЕ обіцяє рух грошей", () => {
...
/**
 * 🧮 #401c — ПЕРЕЛІЧУВАЧ: УСІ ТРИ МІСЦЯ З ЦИМ ЧИСЛОМ НАЗИВАЮТЬ ОДНЕ Й ТЕ САМЕ ПОЛЕ.
 *
 ...
 */
test("#401c усі читачі числа «Заробили» називають поле «Бюджет»", () => {
