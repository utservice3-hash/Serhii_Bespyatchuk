 ...
 *
 * 🔴 `core/plans.ts` НЕ ЧІПАВСЯ ЖОДНИМ РЯДКОМ — це файл контракту
 * (CLAUDE.md, розділ «ЗАДАЧНИК — ЗОВНІШНЯ ДЛЯ ЗВІТУ СИСТЕМА»; посилання за НАЗВОЮ, бо
 * зріз за номером рядка їде від будь-якої правки документа — 28.08.2026 він уже поїхав).
