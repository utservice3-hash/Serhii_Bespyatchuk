...
/**
 * #431b — НОВИЙ МЕНЕДЖЕР БЕЗ ПІДПИСАНОГО ОФЕРА: закрито все, крім Навчання й Документів.
 ...
 */
test("#431b ОФЕР-ГЕЙТ: новий менеджер без підпису — лише training/documents; підписав, або створений до дати, або не менеджер → відкрито", () => {
