 ...
 * ніколи, — червоніє тут.
 */
test("#207b умовний показ: непорожній третій клас додає положення", () => {
...
/**
 * #207c — ДЗЕРКАЛО: ПОРОЖНІЙ ТРЕТІЙ КЛАС ПОЛОЖЕННЯ НЕ ПОКАЗУЄ.
 *
 ...
 * червоніє тут і НЕ червоніє в `#207b`, тобто саботаж розрізняє напрямки.
 */
test("#207c дзеркало: порожній третій клас положення НЕ показує", () => {
...
/**
 * #209b — ТРЕТІЙ КЛАС НА ГРОШАХ: КОЛОНКА УМОВНА, І ЇЇ НЕ ВИМИКАЄ КОРИСТУВАЧ.
 *
 ...
 */
test("#209b колонка «Отримано · невизначено» умовна, а не опційна", () => {
