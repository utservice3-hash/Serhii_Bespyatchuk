...
/**
 * #667 — ЕКРАН ЛІДОГЕНЕРАТОРІВ: номінація, якої в CRM немає, порожня = «чекає ваших даних» (група pending), а не
 * «ніхто не набрав»; менеджерська порожня — лишається «ніхто не набрав». Відсоток конверсії на екрані — до сотих.
 */
test("#667 екран: номінація без CRM чекає даних, а не «ніхто не набрав»; конверсія до сотих", async () => {
