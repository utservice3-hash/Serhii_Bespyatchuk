...
/**
 * ⏳ ОЧІКУВАННЯ БЕЗ ПЛАНОВОЇ ДАТИ ОПЛАТИ — окрема цифра, яка в ЖОДНУ суму не входить.
 *
 * 🔴 ТВЕРДЖЕННЯ, ЯКЕ ТУТ СТОЯЛО, ПЕРЕЖИЛО СВОЮ ПРИЧИНУ. Було: «частина угод не має
 * дати взагалі й не належить жодному місяцю». Заміряно на проді 03.09.2026: таких
 * угод у зоні **НУЛЬ із 378** — планова дата стоїть у 100%. Функція не зламана, вона
 * просто повертає порожньо; але коментар змушував читача думати, що клас непорожній.
 *
 * ⚠️ Тому вона й лишається: клас може ожити будь-коли (поле в CRM необовʼязкове), а
 * тоді угоди без дати мусять бути ВИДНІ, а не мовчки випасти з підсумків. Розмір
 * класу сьогодні — нуль, і саме через це `#26r` перевіряє його ФІКСТУРОЮ: живий гейт
 * при нульовому класі був би зеленим на зламаному коді просто тому, що стану немає.
 * Четверте відро плитки «Очікуємо» показується навіть порожнім із тієї ж причини.
 */
