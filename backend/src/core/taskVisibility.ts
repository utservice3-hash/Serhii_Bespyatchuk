 ...
 * менеджера-автора; тримає її гейт `#399`.
 *
 ...
 * Гейт `#399e` звіряє, що вью в схемі каже те саме, що ця функція.
 */
 ...
 * `#399e`, коли звіряє вью `ai_tasks` у схемі. Сенс не в економії рядків:
