 ...
 * менеджера-автора; тримає її гейт `#398`.
 *
 ...
 * Гейт `#398e` звіряє, що вью в схемі каже те саме, що ця функція.
 */
 ...
 * `#398e`, коли звіряє вью `ai_tasks` у схемі. Сенс не в економії рядків:
