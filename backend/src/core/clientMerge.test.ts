...
/**
 * #420c — ДВЕРІ «КЛІЄНТИ» ТЕЖ ПИШУТЬ У РЕЄСТР І ПЕРЕРАХОВУЮТЬ В ОДНІЙ ТРАНЗАКЦІЇ.
 *
 ...
 */
test("#420c ДВЕРІ «КЛІЄНТИ»: реєстр і перерахунок в ОДНІЙ транзакції", () => {
...
/**
 * #420d — ВІДМОВА НАЗИВАЄ ОДНУ ПРИЧИНУ, А НЕ ТРИ.
 *
 ...
 */
test("#420d ВІДМОВА НАЗИВАЄ ОДНУ ПРИЧИНУ: три стани — три різні тексти", () => {
