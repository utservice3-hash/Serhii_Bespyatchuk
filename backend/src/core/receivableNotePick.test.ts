...
test("#253c НІЧИЯ ЗА ДАТОЮ не втрачає коментар — випадок «автострадавк»", () => {
  // 📐 Не гіпотеза. На проді 01.09.2026 обидві нотатки «автострадавк» оновлені
  // в ОДНУ хвилину (2026-08-27 09:43): у псевдоніма дедлайн 29.08 і ПОРОЖНІЙ
  // коментар, у канонічного — дедлайн 28.08 і коментар на 29 символів.
  // Сортування лише за датою дало псевдонім, тобто екран показав би МЕНШЕ, ніж
  // показує сьогодні. Рішення власника: порядок, який показує менше, суперечить
  // самому правилу, заради якого пишеться.
