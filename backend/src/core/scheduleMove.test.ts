 ...
 * на сьогодні — як перенести на завтра або видалити, щоб не тягнулось у звітність») — гейт `#650`.
...
/**
 * #650 — ДІЇ Є І ЙДУТЬ ЧЕРЕЗ ТОЙ САМИЙ ЗАПИС РЯДКА: «Розклад» передає в картку `onMove` і `onRemove`;
 ...
 */
test("#650 РОЗКЛАД: рядок можна перенести й видалити; перенесення — той самий запис, видалення — скасовне", () => {
