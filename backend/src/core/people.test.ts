...
/**
 * #626 — ФАЙЛ ФОТО ПЕРЕВІРЯЄТЬСЯ ЗА БАЙТАМИ. JPEG/PNG/WebP проходять із правильним типом; PDF (його
 ...
 */
test("#626 фото: приймаються лише JPEG/PNG/WebP за байтами, до 5 МБ включно", () => {
...
/**
 * #628 — КОЖНА ДІЯ З ФОТО СКАСОВНА. «Прибрати» → «Повернути попереднє» дає рівно той самий файл;
 ...
 */
test("#628 фото: прибрати/замінити скасовуються «Повернути попереднє», нічого не губиться", () => {
