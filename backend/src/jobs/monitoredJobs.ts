...
export const MONITORED_JOBS: { name: string; everyMin: number; why: string }[] = [
  ...
  // 📋 ДОДАНО 11.08.2026 РАЗОМ ІЗ ДЖОБОЮ, а не «потім»: мовчання синку задач зробить
  // критерій застрягання сліпим на 79% активних угод, і побачити це буде ніяк.
  // Рівно та помилка, через яку backupDb падав 12 днів непоміченим.
  { name: "syncKommoTasks", everyMin: 30, why: "задачі — четверте джерело активності; мовчання = угоди виглядають застряглими помилково" },
