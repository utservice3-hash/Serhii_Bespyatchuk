...
test("#29 ВІКНО ДЛЯ RINGOSTAT — КИЇВСЬКЕ, а не UTC", async () => {
  // 🔴 Регресія 05.08.2026: джоба будувала вікно з `getUTC*`, а Ringostat читає
  ...
  assert.equal(__kyivStampForTest(d), "2026-08-05 11:50:00",
    "🔴 штамп не київський — джоба просить вікно на 3 години в минулому");
  // Взимку зсув +2 — перевіряємо, що це НЕ хардкод «+3».
  const w = new Date("2026-01-15T08:50:00.000Z");
