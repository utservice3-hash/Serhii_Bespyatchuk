...
/**
 * 🔗 #647 — фікстура по ОБИДВА боки межі, інакше гейт доводив би лише те, що функція
 ...
 */
test("#647 SYNCBANK: збій одного рахунку з токеном — помилка з його назвою; усі в порядку — успіх; без токена — не помилка", () => {
...
/**
 * 🪞 #647b — ДЖЕРЕЛО `syncBank.ts` справді кличе рішення й кидає його помилку. Без цього
 * #647 зеленів би на чистій функції, яку ніхто не викликає — рівно стан до 22.09.2026,
 ...
 */
test("#647b 🪞 ДЖЕРЕЛО: syncBank кличе syncBankOutcome і кидає його помилку, а не ковтає в catch", () => {
