...
export const ALLOWED_PROD_SKIPS: { name: string; why: string }[] = [
  ...
  { name: "#66 ПРАВИЛО «новий/постійний» дає очікуваний клас на ВСІХ шести гілках",
  ...
  { name: "#66b ДВІ ФОРМИ ПРАВИЛА (CTE і інлайн) збігаються порядково",
  ...
  { name: "#76e UPSERT ІДЕМПОТЕНТНИЙ і оновлює стан задачі",
    why: "піднімає одноразовий кластер PostgreSQL — на прод-сервері бінарів PG немає (Neon). "
       + "⚠️ #76/#76b/#76c/#76d бази НЕ потребують і виконуються в проді" },
