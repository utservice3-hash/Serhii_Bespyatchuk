 ...
 * єдина копія, вона одна на весь фронт, і її звіряє гейт `#145c`: розійтись мовчки
 * вони не можуть.
 */
 ...
 * `#145`. Дірка тут означала б «бейджа немає» рівно для тих значень, які ніхто не
 * перевіряв руками.
 */
 ...
 * вона перетворює «Добре» на «Відмінно». Тримає `#145b`.
 */
