...
/**
 * 🛑 #325/#325b — ПІДПИС УЧАСНИКА НЕ БУВАЄ ПОРОЖНІМ І НЕ БУВАЄ ДЕФОЛТНИМ.
 *
 ...
 */
test("#325 порожній і дефолтний підпис ВІДМОВЛЯЮТЬСЯ, справжній проходить", async () => {
...
test("#325b 🪞 ДЗЕРКАЛО: ланцюг не має ЖОДНОГО дефолту, а нове імʼя ПОПЕРЕДЖАЄ", async () => {
