...
/**
 * 🛑 #320/#320b — ПІДПИС УЧАСНИКА НЕ БУВАЄ ПОРОЖНІМ І НЕ БУВАЄ ДЕФОЛТНИМ.
 *
 ...
 */
test("#320 порожній і дефолтний підпис ВІДМОВЛЯЮТЬСЯ, справжній проходить", async () => {
...
test("#320b 🪞 ДЗЕРКАЛО: ланцюг не має ЖОДНОГО дефолту, а нове імʼя ПОПЕРЕДЖАЄ", async () => {
