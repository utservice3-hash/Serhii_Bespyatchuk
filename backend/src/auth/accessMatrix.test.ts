...
const ADMIN_DENIED_BY_PERM: Record<string, string> = {
  ...
  "POST /api/secrets/exit": "view_employee_secrets — лише admin, ceo, opdir, kvp, hr (рішення Романа 18.09.2026); фінансист його не має",
  "PATCH /api/secrets/exit/:id": "view_employee_secrets — лише admin, ceo, opdir, kvp, hr (рішення Романа 18.09.2026); фінансист його не має",
  "POST /api/secrets/exit/:id/restore": "view_employee_secrets — лише admin, ceo, opdir, kvp, hr (рішення Романа 18.09.2026); фінансист його не має",
  "DELETE /api/secrets/exit/:id": "view_employee_secrets — лише admin, ceo, opdir, kvp, hr (рішення Романа 18.09.2026); фінансист його не має",
