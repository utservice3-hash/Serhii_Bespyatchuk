 ...
 * `financier` з `allow` рядка `/ads/deals` → червоніє `#398`.
 */
/**
 ...
 */
test("#398 склад дня «Реклами» відкритий фінансисту — як і сам екран", () => {
...
/**
 * 🪞 #398b — ДЗЕРКАЛО `#398`, і воно важливіше за сам `#398`.
 *
 ...
 */
test("#398b 🪞 склад дня НЕ став доступніший за екран", () => {
