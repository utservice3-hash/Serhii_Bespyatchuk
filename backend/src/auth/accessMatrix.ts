...
export const ACCESS_MATRIX: AccessRow[] = [
  ...
  { method: "GET", path: "/api/hiring/candidates", cls: "GET",
    allow: ["admin", "ceo", "opdir", "kvp", "hr", "team_lead"], deny: ["financier", "manager"] },
  { method: "GET", path: "/api/hiring/candidates/:id", cls: "GET",
    allow: ["admin", "ceo", "opdir", "kvp", "hr", "team_lead"], deny: ["financier", "manager"] },
  { method: "GET", path: "/api/hiring/schedule?from=2026-09-01&to=2026-09-07", cls: "GET",
    allow: ["admin", "ceo", "opdir", "kvp", "hr"], deny: ["team_lead", "financier", "manager"] },
  { method: "GET", path: "/api/hiring/daily?from=2026-09-01&to=2026-09-07", cls: "GET",
    allow: ["admin", "ceo", "opdir", "kvp", "hr"], deny: ["team_lead", "financier", "manager"] },
  { method: "POST", path: "/api/hiring/interviews", cls: "deny-only",
    allow: [], deny: ["team_lead", "manager"] },
  { method: "PATCH", path: "/api/hiring/interviews/:id", cls: "deny-only",
    allow: [], deny: ["team_lead", "manager"] },
  { method: "DELETE", path: "/api/hiring/interviews/:id", cls: "DELETE-ghost",
    allow: ["admin", "ceo", "opdir", "kvp", "hr"], deny: ["team_lead", "financier", "manager"] },
  { method: "POST", path: "/api/hiring/interviews/:id/restore", cls: "deny-only",
    allow: [], deny: ["team_lead", "manager"] },
  { method: "POST", path: "/api/hiring/candidates", cls: "deny-only",
    allow: [], deny: ["team_lead", "manager"] },
  { method: "PATCH", path: "/api/hiring/candidates/:id", cls: "deny-only",
    allow: [], deny: ["team_lead", "manager"] },
  { method: "POST", path: "/api/hiring/candidates/:id/status", cls: "deny-only",
    allow: [], deny: ["manager"] },
  { method: "POST", path: "/api/hiring/candidates/:id/comment", cls: "deny-only",
    allow: [], deny: ["manager"] },
  { method: "PUT", path: "/api/hiring/daily/:day", cls: "deny-only",
    allow: [], deny: ["team_lead", "manager"] },
  ...
  { method: "POST", path: "/api/hiring/vacancies", cls: "deny-only",
    allow: [], deny: ["team_lead", "manager"] },
  { method: "PATCH", path: "/api/hiring/vacancies/:id", cls: "deny-only",
    allow: [], deny: ["team_lead", "manager"] },
  { method: "PUT", path: "/api/hiring/candidates/:id/vacancies", cls: "deny-only",
    allow: [], deny: ["team_lead", "manager"] },
  { method: "POST", path: "/api/hiring/refusal-reasons", cls: "deny-only",
    allow: [], deny: ["team_lead", "manager"] },
  { method: "POST", path: "/api/hiring/candidates/:id/refuse", cls: "deny-only",
    allow: [], deny: ["manager"] },
  { method: "POST", path: "/api/hiring/candidates/:id/reserve", cls: "deny-only",
    allow: [], deny: ["team_lead", "manager"] },
  { method: "POST", path: "/api/hiring/candidates/:id/files", cls: "deny-only",
    allow: [], deny: ["team_lead", "manager"] },
  { method: "GET", path: "/api/hiring/candidates/:id/files/:fileId", cls: "GET",
    allow: ["admin", "ceo", "opdir", "kvp", "hr", "team_lead"], deny: ["financier", "manager"] },
  { method: "DELETE", path: "/api/hiring/candidates/:id/files/:fileId", cls: "DELETE-ghost",
    allow: ["admin", "ceo", "opdir", "kvp", "hr"], deny: ["team_lead", "financier", "manager"] },
  ...
  { method: "DELETE", path: "/api/documents/folder/:id", cls: "DELETE-ghost",
    allow: ["admin", "ceo", "opdir", "kvp", "hr"], deny: ["financier", "team_lead", "manager"] },
  { method: "PUT", path: "/api/documents/folders/order", cls: "deny-only",
    allow: [], deny: ["financier", "team_lead", "manager"] },
  { method: "PATCH", path: "/api/documents/folder/:id", cls: "deny-only",
    allow: [], deny: ["financier", "team_lead", "manager"] },
  // 📁 Документи v2 (15.09.2026): читання — усі з вкладкою, предикат усередині; запис — керівництво.
  { method: "GET", path: "/api/documents/tree", cls: "GET",
    allow: ["admin", "ceo", "opdir", "kvp", "financier", "hr", "team_lead", "manager"], deny: [] },
  { method: "GET", path: "/api/documents/file/:id", cls: "GET",
    allow: ["admin", "ceo", "opdir", "kvp", "financier", "hr", "team_lead", "manager"], deny: [] },
  { method: "GET", path: "/api/documents/people", cls: "GET",
    allow: ["admin", "ceo", "opdir", "kvp", "hr"], deny: ["financier", "team_lead", "manager"] },
  { method: "GET", path: "/api/documents/file/:id/viewers", cls: "GET",
    allow: ["admin", "ceo", "opdir", "kvp", "hr"], deny: ["financier", "team_lead", "manager"] },
  { method: "GET", path: "/api/documents/file/:id/signature/:sigId/evidence", cls: "GET",
    allow: ["admin", "ceo", "opdir", "kvp", "financier", "hr", "team_lead", "manager"], deny: [] },
  { method: "POST", path: "/api/documents/file/:id/version", cls: "deny-only",
    allow: [], deny: [] },
  { method: "POST", path: "/api/documents/file/:id/archive", cls: "deny-only",
    allow: [], deny: ["financier", "team_lead", "manager"] },
  { method: "GET", path: "/api/documents/trash", cls: "GET",
    allow: ["admin", "ceo", "opdir", "kvp", "hr"], deny: ["financier", "team_lead", "manager"] },
  { method: "POST", path: "/api/documents/file/:id/undelete", cls: "deny-only",
    allow: [], deny: ["financier", "team_lead", "manager"] },
  ...
  { method: "POST", path: "/api/documents/file/:id/signature/:sigId/approve", cls: "deny-only",
    allow: [], deny: ["team_lead", "manager"] },
  { method: "POST", path: "/api/documents/file/:id/signature/:sigId/reject", cls: "deny-only",
    allow: [], deny: ["team_lead", "manager"] },
  { method: "POST", path: "/api/documents/file/:id/presigned", cls: "deny-only",
    allow: [], deny: ["financier", "team_lead", "manager"] },
  { method: "POST", path: "/api/documents/file/:id/presigned/undo", cls: "deny-only",
    allow: [], deny: ["financier", "team_lead", "manager"] },
  { method: "POST", path: "/api/documents/file/:id/ack", cls: "deny-only",
    allow: [], deny: [] },
  { method: "GET", path: "/api/documents/file/:id/acks", cls: "GET",
    allow: ["admin", "ceo", "opdir", "kvp", "hr"], deny: ["financier", "team_lead", "manager"] },
  { method: "POST", path: "/api/documents/file/:id/ack-remind", cls: "deny-only",
    allow: [], deny: ["team_lead", "manager"] },
  { method: "POST", path: "/api/documents/file/:id/restore", cls: "deny-only",
    allow: [], deny: ["financier", "team_lead", "manager"] },
  { method: "POST", path: "/api/documents/file/:id/sign", cls: "deny-only",
    allow: [], deny: [] },
  { method: "GET", path: "/api/documents/access/:folderId", cls: "GET",
    allow: ["admin", "ceo", "opdir", "kvp", "hr"], deny: ["financier", "team_lead", "manager"] },
  { method: "PUT", path: "/api/documents/access/:folderId", cls: "deny-only",
    allow: [], deny: ["financier", "team_lead", "manager"] },
  { method: "GET", path: "/api/documents/search", cls: "GET",
    allow: ["admin", "ceo", "opdir", "kvp", "financier", "hr", "team_lead", "manager"], deny: [] },
  { method: "GET", path: "/api/documents/file/:id/render", cls: "GET",
    allow: ["admin", "ceo", "opdir", "kvp", "financier", "hr", "team_lead", "manager"], deny: [] },
  { method: "GET", path: "/api/documents/file/:id/access", cls: "GET",
    allow: ["admin", "ceo", "opdir", "kvp", "hr"], deny: ["financier", "team_lead", "manager"] },
  { method: "PUT", path: "/api/documents/file/:id/access", cls: "deny-only",
    allow: [], deny: ["financier", "team_lead", "manager"] },
  { method: "GET", path: "/api/documents/tree", cls: "GET",
    allow: ["admin", "ceo", "opdir", "kvp", "financier", "hr", "team_lead", "manager"], deny: [] },
  ...
  { method: "GET", path: "/api/auth/screens", cls: "deny-only",
    allow: [], deny: [] },
