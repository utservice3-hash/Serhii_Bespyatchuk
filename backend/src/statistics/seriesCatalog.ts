...
export const LIVE_TEAMS: { id: number; name: string }[] = [
  ...
  // 🟢 РОЗФОРМОВАНО (рішення власника 05.08.2026): з серпня 2026 у складі команди
  //    Яцика. Серію ЛИШАЄМО живою і дані НЕ зносимо — вона тримає історію за
  //    попередні періоди. Після переносу Шевчука команда стане порожньою, тож із
  //    селекторів зникне сама (`routes/teams.ts` ховає команди без активних
  //    менеджерів), а тут лишиться як історичний ряд із явною позначкою.
  { id: 36283, name: "Самостійні (розформовано · з 08.2026 у Яцика)" },
