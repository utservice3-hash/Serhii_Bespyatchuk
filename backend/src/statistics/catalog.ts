...
export const CATALOG: DepartmentDef[] = [
  {
    ...
    metrics: [
      ...
      { key: "machines_dispatched", label: "Відправлені машини (знімок; означення з 07.2026)", unit: "count", source: "auto", aggregation: "sum", csvIndexMonth: 16, csvIndexWeek: 10, order: 9 , note: "Створені в цьому місяці, поїхали (за датою завантаження) і оплата ще НЕ зайшла; закриті «не реалізовано» виключені — рішення власника 02.09.2026. ДВА РІЗНІ ЗАСТЕРЕЖЕННЯ, і вони не про одне й те саме. (1) ЗНІМОК: стан на СЬОГОДНІ, а не за той місяць — показник тане, бо все врешті або оплачується, або падає в 143 (заміряно 02.09: серпень 250, липень 67, червень 17, грудень 2025 — 3). (2) ОЗНАЧЕННЯ З 07.2026: до липня 2026 тут лежить ІНША величина — копія «успішних угод» (2026-01…06, ~700-1000) і до 2025-12 числа з листа; вони не перераховуються (джоба бачить лише останні 75 днів) і з новими не порівнюються. Означення й усі заміряні факти — core/dispatched.ts" },
    ],
  },
  {
    key: "leadgen",
