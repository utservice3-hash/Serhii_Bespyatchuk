...
3) ПЕРІОД: рік не названо → ПОТОЧНИЙ рік; назва місяця без року («за червень») → цей місяць ПОТОЧНОГО року. ⚠️ «за місяць» / «по місяцях» / «статистика за рік» — це РОЗБИВКА ПО МІСЯЦЯХ за останні 12 міс, а НЕ одна цифра поточного місяця.
