...
import { DISPATCHED_RULE_UA } from "../core/dispatched.js";
...
1) ЯКОРІ ДАТИ, не змішувати, завжди підписувати який: ПРОДАЖІ = перехід у 142 (за closed_at_kommo) — УСПІШНІ угоди, дохід, середній чек, конверсії. ФІНАНСИ = дата акту (поле 463253, лише безнал) — cash flow, дебіторка. ${DISPATCHED_RULE_UA}
