...
/**
 * #602 — НОМІНАЦІЇ ПРОТИ БАЗИ З НУЛЯ: обробники ВИКОНУЮТЬСЯ, знімок НЕЗМІННИЙ після фіксації.
 *
 ...
 */
test("#602 ДИМ: номінації тижня проти бази з нуля — межі, рішення тімліда, фіксація й незмінність знімка", async (t) => {
