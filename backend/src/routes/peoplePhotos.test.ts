...
/**
 * #644 — ФОТО СПІВРОБІТНИКА ПРОТИ БАЗИ З НУЛЯ, ЧЕРЕЗ СПРАВЖНІЙ HTTP (22.09.2026). Роутер разом із
 ...
 */
test("#644 ДИМ: фото — HR завантажує, команда бачить (кандидат — ні), тімлід не пише; кожна дія скасовна", async (t) => {
