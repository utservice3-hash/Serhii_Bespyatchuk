...
/**
 * #398h — ДИМОВИЙ ПРОГІН СПІЛЬНОЇ ЗАДАЧІ: обробники ВИКОНУЮТЬСЯ проти бази з нуля.
 *
 * 🔴 НАВІЩО, ЯКЩО Є #398 І #398d. Ті перевіряють ПРАВИЛО (чисті функції) і УМОВУ
 ...
 */
test("#398h ДИМ: усі роути спільної задачі виконуються проти бази з нуля, межі віддають свої коди", async (t) => {
