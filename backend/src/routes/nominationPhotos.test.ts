...
/**
 * #631 — ФОТО ДОХОДЯТЬ ДО НОМІНАЦІЙ І ВІТАЛЬНИХ СЛАЙДІВ ЧЕРЕЗ РОУТИ (22.09.2026), по обидва боки:
 ...
 */
test("#631 ДИМ: фото доходять до номінацій і вітальних слайдів — лише привʼязані й обрані", async (t) => {
