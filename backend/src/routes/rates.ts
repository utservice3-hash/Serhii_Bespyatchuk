...
import { ZONE_RATES, ZONE_LABEL, marginFor, zoneRecommendation, type Zone } from "../core/zoneRates.js";
// Зони областей, маржа й zoneRecommendation — у `core/zoneRates.ts` (чистий модуль, гейт #397d).
