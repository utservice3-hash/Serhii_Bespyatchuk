...
/**
 * #612 — КОЖЕН ШАБЛОН ПРОХОДИТЬ ЧЕРЕЗ РОУТ І БАЗУ: слайд шаблону з полями за замовчуванням
 ...
 */
test("#612 ДИМ: слайд кожного шаблону зберігається й читається назад з тими самими полями", async (t) => {
