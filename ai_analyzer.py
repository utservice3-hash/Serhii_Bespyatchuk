...
В кінці окремим рядком ОБОВ'ЯЗКОВО вкажи: "RISK: ТАК - <короткий привід тривоги в 1 речення>" якщо є ризик втрати угоди (клієнт сумнівається, обрав конкурента, скаржиться, незадоволений, мовчить довго без реакції менеджера) — або "RISK: НІ" якщо ризику немає.
